...
{
	static  int step=0,dir=0;
	
//	if (dir == 0){
	GimbalRef.yaw_angle_dynamic_ref   = 1000 * STICK_TO_YAW_ANGLE_INC_FACT;
	ChassisSpeedRef.left_right_ref = 300* STICK_TO_CHASSIS_SPEED_REF_FACT;
//	}else {
//	GimbalRef.yaw_angle_dynamic_ref   = -1000 * STICK_TO_YAW_ANGLE_INC_FACT;
//		ChassisSpeedRef.left_right_ref = 300* STICK_TO_CHASSIS_SPEED_REF_FACT;
//	}
