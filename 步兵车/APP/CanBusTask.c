...
************************************************************************************************************************
*/
short pitchToSend=0,yawToSend=0;
...
{      
		...
		switch(msg->StdId)
		{
				...
				case CAN_BUS2_MOTOR5_FEEDBACK_MSG_ID:
				{
					LostCounterFeed(GetLostCounter(LOST_COUNTER_INDEX_MOTOR5));
					 ...
					 EncoderProcess(&GMYawEncoder ,msg);  
										yawToSend=(short)(GMYawEncoder.ecd_angle*100);
					info[8]=BYTE1(yawToSend);
					info[9]=BYTE0(yawToSend);
				...
				case CAN_BUS2_MOTOR6_FEEDBACK_MSG_ID:
				{
					...
					pitchToSend=(short)(GMPitchEncoder.ecd_angle*100);
					info[6]=BYTE1(pitchToSend);
					info[7]=BYTE0(pitchToSend);
						//码盘中间值设定也需要修改
						 if(can_count<=100)
						 {
...
//					yawToSend=(short)(ZGyroModuleAngle*100);
//					info[8]=BYTE1(yawToSend);
//					info[9]=BYTE0(yawToSend);
				}break;
				default:
