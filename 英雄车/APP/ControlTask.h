...
#define STATE_SWITCH_DELAY_TICK 10000000   //mode change delay count in ms

#define YAW_POSITION_KP_DEFAULTS  5.0
#define YAW_POSITION_KI_DEFAULTS  0.0
#define YAW_POSITION_KD_DEFAULTS  0.0

#define YAW_SPEED_KP_DEFAULTS  4.0
...
//big bang   22.5 20.0
#define PITCH_POSITION_KP_DEFAULTS  22.5
#define PITCH_POSITION_KI_DEFAULTS  0.00
#define PITCH_POSITION_KD_DEFAULTS  0

#define PITCH_SPEED_KP_DEFAULTS  20.0
